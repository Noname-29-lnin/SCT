...
\subsubsection{Kiểm tra chương trình trên ESP32-C3-DevKitM-1}

Nhóm em sử dụng DEVKIT V1 ESP32 để kiểm tra trước chương trình vì DEVKIT trên chip ESP32-C3. Nhóm em sử dung thêm phần mền \textbf{Serial Bluetooth Terminal} (\includegraphics[width=.03\linewidth]{./my-chapters/my-images/implementation/Ble/unnamed.png}) để kiểm tra dữ liệu gửi về smartphone. 
...
\subsubsection{Sơ đồ khối của bộ BLE với chip ESP32-C3}
...
Từ đó, nhóm chọn các thông số:
\begin{itemize}[label=-]
	\item Chiều rộng đường dây: $W = 0.841706 \,\textsf{mm}$
	\item Chiều dài đường dây: $L = 7\,\textsf{mm}$
\end{itemize}
